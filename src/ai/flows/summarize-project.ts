...
const SummarizeProjectInputSchema = z.object({
  projectText: z
    .string()
    .describe('The project text to summarize. Can be project descriptions, document content, etc.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert project summarizer. You will create a concise summary of the project, highlighting the key aspects and outcomes.
